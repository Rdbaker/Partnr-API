module V1::Entities
  class ProjectData
    ...
    class AsFull < AsSearch
      ...
      expose :roles, documentation: { type: "RoleData (nested)", desc: "The roles for the project." }, using: RoleData::AsNested
      expose :bmarks, documentation: { type: "BenchmarkData (nested)", desc: "The benchmarks for the project." }, using: BenchmarkData::AsNested, as: :benchmarks
